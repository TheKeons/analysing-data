...
class Placeholder:
    def __init__(self, file) -> None:
        ...
        self.pred_30 = [self.point_slope_form(self.average_growth_rate_30)(i) for i in self.x_prediction]
        self.pred_15 = [self.point_slope_form(self.average_growth_rate_15)(i) for i in self.x_prediction]
        self.pred_5 = [self.point_slope_form(self.average_growth_rate_5)(i) for i in self.x_prediction]
    ...
    def point_slope_form(self, growth_rate):
        return lambda x: growth_rate * (x - self.x1) + self.y1
    ...
    def plot_derivative(self, goal):
        plt.plot(self.x[1:], [i * 1000000 for i in self.der()])
